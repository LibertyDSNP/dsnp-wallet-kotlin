package com.unfinished.core.db.model.chain
...
class MetaAccountLocal(
    ...
    val substrateCryptoType: com.unfinished.common.core.api.model.CryptoType?,
...
class ChainAccountLocal(
    ...
    val cryptoType: com.unfinished.common.core.api.model.CryptoType?,
)
