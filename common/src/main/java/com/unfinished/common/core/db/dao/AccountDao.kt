package com.unfinished.core.db.dao
...
abstract class AccountDao {
    ...
    abstract suspend fun getAccounts(query: String, networkType: com.unfinished.common.core.api.model.Node.NetworkType): List<AccountLocal>
