...
class Switch @JvmOverloads constructor(
    ...
    private val view: View = View.inflate(context, R.layout.view_switch, this)
    private val viewSwitchField: SwitchMaterial = view.findViewById(R.id.viewSwitchField)
    private val viewSwitchSubtitle: TextView = view.findViewById(R.id.viewSwitchSubtitle)
    private val viewSwitchTitle: TextView = view.findViewById(R.id.viewSwitchField)
    ...
    private fun applyAttributes(attributeSet: AttributeSet) =
        context.useAttributes(attributeSet, R.styleable.Switch) {
            ...
            val dividerVisible =
                it.getBoolean(R.styleable.Switch_dividerVisible, DIVIDER_VISIBLE_DEFAULT)
