...
import com.unfinished.account.databinding.FragmentExportJsonPasswordBinding
...
class ExportJsonPasswordFragment : BaseFragment<ExportJsonPasswordViewModel>() {
    ...
    override fun subscribe(viewModel: ExportJsonPasswordViewModel) {
        ...
        binding.exportJsonPasswordConfirmField.content.bindTo(
            viewModel.passwordConfirmationFlow,
            lifecycleScope
        )
