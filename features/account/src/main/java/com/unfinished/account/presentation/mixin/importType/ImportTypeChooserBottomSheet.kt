...
class ImportTypeChooserBottomSheet(
    ...
    private fun item(
        ...
        item(com.unfinished.account.R.layout.item_source_type) {
            it.findViewById<ImageView>(com.unfinished.account.R.id.itemSourceTypeIcon).setImageResource(icon)
            it.findViewById<TextView>(com.unfinished.account.R.id.itemSourceTypeTitle).setText(title)
            it.findViewById<TextView>(com.unfinished.account.R.id.itemSourceTypeSubtitle).setText(subtitle)
