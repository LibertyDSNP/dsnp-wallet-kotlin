...
import com.unfinished.account.presentation.mnemonic.confirm.ConfirmMnemonicPayload.CreateExtras
import com.unfinished.account.presentation.mnemonic.confirm.MnemonicWord
import com.unfinished.account.presentation.mnemonic.reArrangeWords
import com.unfinished.account.presentation.mnemonic.twoDigitIndex
...
class BackupMnemonicViewModel @AssistedInject constructor(
    ...
    val continueText = flowOf {
        val stringRes = when (payload) {
            ...
            is BackupMnemonicPayload.Create -> com.unfinished.account.R.string.seed_phrase_btn
        }
