...
class AddressInputField @JvmOverloads constructor(
    ...
    private fun applyAttributes(attrs: AttributeSet) = context.useAttributes(attrs, com.unfinished.feature_account.R.styleable.AddressInputField) {
        val hint = it.getString(com.unfinished.feature_account.R.styleable.AddressInputField_android_hint)
